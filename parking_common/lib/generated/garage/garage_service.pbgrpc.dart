...
import 'garage_service.pb.dart' as $0;

export 'garage_service.pb.dart';

/// GarageService — Busca de garagens e sistema de reservas
@$pb.GrpcServiceName('garage.GarageService')
class GarageServiceClient extends $grpc.Client {
  ...
  GarageServiceClient(super.channel, {super.options, super.interceptors});
  ...
  static final _$searchGarages =
      $grpc.ClientMethod<$0.SearchRequest, $0.SearchResponse>(
          '/garage.GarageService/SearchGarages',
  ...
  static final _$getGarage = $grpc.ClientMethod<$0.GetGarageRequest, $0.Garage>(
      '/garage.GarageService/GetGarage',
  ...
  static final _$createReservation =
      $grpc.ClientMethod<$0.CreateReservationRequest, $0.Reservation>(
          '/garage.GarageService/CreateReservation',
  ...
  static final _$listReservations = $grpc.ClientMethod<
      ...
      '/garage.GarageService/ListReservations',
  ...
  static final _$cancelReservation = $grpc.ClientMethod<
      ...
      '/garage.GarageService/CancelReservation',
      ($0.CancelReservationRequest value) => value.writeToBuffer(),
      $0.CancelReservationResponse.fromBuffer);
}

@$pb.GrpcServiceName('garage.GarageService')
abstract class GarageServiceBase extends $grpc.Service {
  $core.String get $name => 'garage.GarageService';
