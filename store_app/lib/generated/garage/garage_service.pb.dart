...
class SearchRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'garage'),
...
class Garage extends $pb.GeneratedMessage {
  factory Garage({
    ...
    $core.Iterable<$1.Campaign>? campaigns,
    $core.String? address,
    $core.String? phone,
    $core.int? totalSpots,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<$1.Campaign>(7, _omitFieldNames ? '' : 'campaigns',
  ...
  @$pb.TagNumber(7)
  $pb.PbList<$1.Campaign> get campaigns => $_getList(6);
...
class Reservation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<$1.ReservationStatus>(9, _omitFieldNames ? '' : 'status',
        enumValues: $1.ReservationStatus.values)
  ...
  @$pb.TagNumber(9)
  $1.ReservationStatus get status => $_getN(8);
  @$pb.TagNumber(9)
  set status($1.ReservationStatus value) => $_setField(9, value);
  @$pb.TagNumber(9)
...
class ListReservationsRequest extends $pb.GeneratedMessage {
  factory ListReservationsRequest({
    $core.String? userId,
    $1.ReservationStatus? statusFilter,
  }) {
    final result = create();
    if (userId != null) result.userId = userId;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'userId')
    ..aE<$1.ReservationStatus>(2, _omitFieldNames ? '' : 'statusFilter',
        enumValues: $1.ReservationStatus.values)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $1.ReservationStatus get statusFilter => $_getN(1);
  @$pb.TagNumber(2)
  set statusFilter($1.ReservationStatus value) => $_setField(2, value);
  @$pb.TagNumber(2)
